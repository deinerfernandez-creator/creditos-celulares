...
import { User, ArrowRight, ShieldCheck, Hash, Loader2, Smartphone, Home } from 'lucide-react';
...
export default function PortalLoginPage() {
  ...
  const handleAccess = async (e: React.FormEvent) => {
    ...
    try {
      // 1. Buscar al cliente por cédula (Sin login obligatorio)
    ...
    <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center p-4">
      <div className="w-full max-w-md mb-8 flex justify-start">
        <Button variant="ghost" size="sm" asChild className="rounded-xl text-slate-500 hover:text-primary">
          <Link href="/login"><Home className="w-4 h-4 mr-2" /> Panel Staff</Link>
        </Button>
      </div>

      <div className="w-full max-w-md space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
        <div className="text-center space-y-4">
          <div className="inline-flex p-1 bg-white rounded-2xl shadow-xl overflow-hidden w-20 h-20 items-center justify-center border-2 border-primary/5">
            <Image 
          ...
          <div className="space-y-1">
            <h1 className="text-2xl font-black tracking-tight text-slate-900">Portal de Clientes</h1>
        ...
        <Card className="border-none shadow-2xl bg-white rounded-3xl overflow-hidden">
          <CardHeader className="bg-slate-50/50 border-b pb-6">
            ...
            <CardDescription className="text-[10px] uppercase font-bold tracking-widest text-slate-400">Introduce tus datos registrados</CardDescription>
          </CardHeader>
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-2 mt-2 px-1">
                  ...
                  <p className="text-[10px] text-muted-foreground">
                    Marca <strong>*#06#</strong> para conocer tu IMEI.
                  </p>
                </div>
              </div>
          ...
          <CardFooter className="bg-slate-50/50 p-4 text-center border-t">
